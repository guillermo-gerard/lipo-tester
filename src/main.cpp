...
//Version-1.0.1
//by deba168,INDIA . modified by Guillermo Gerard
//Dated : 28/07/2019
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
...
float Res_Value = 6.71;  // Resistor Value in Ohm, 7*47ohm in parallel, 
                        //this gives a current of 620 mA fully charged and 440mA at the lowest point 
float Vcc = 4.77; // Voltage of Arduino 5V pin ( Mesured by Multimeter )
  ...
  if ( Bat_Volt > Bat_High){
    ...
    delay(1000);
      ...
      Serial.println(Bat_Volt);
            ...
            Serial.print("Bat_Low: " );
      Serial.println(Bat_Low);
      ...
      Current = (Bat_Volt) / Res_Value; //- Res_Volt) / Res_Value;
      mA = Current * 1000.0 ;
